...
function adicionarCampo2() {
    controleCampo2++;
    console.log('adicionarCampo2 chamado, controleCampo2:', controleCampo2);

    // Faz a requisição AJAX para obter os produtos
    fetch('php/mesa/getmenuentrada.php')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            const campoHTML = `
                <div class="form-group" id="campo${controleCampo2}">
            ...
            document.getElementById('formulario2').insertAdjacentHTML('beforeend', campoHTML);
        })
